...
} else if (choose == books[1].id) {
  console.log(books[1].name);
} else if (choose == books[2].id) {
  console.log(books[2].name);
} else if (choose == books[3].id) {
  console.log(books[3].name);
} else if (choose == books[4].id) {
...
leftLessons() < 12
  ? console.log("You have done more then half course")
  : console.log("You have done less then half course");
